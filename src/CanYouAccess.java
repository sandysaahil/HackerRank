 ...
 * The powerof2 in class Inner.Private checks whether a number is a power of . You have to call the method powerof2 of 
 * the class Inner.Private from the main method of the class Solution.
 * 
 * Constraints 
 * 
 * Sample Input
